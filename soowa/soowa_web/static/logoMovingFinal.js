...
sentence_list['2']= ['cloud','above','be','if','here','probably'];
...
//가이드영상 경로 리스트
var guideVideo_list = {};
guideVideo_list['1']= ['static/sentence3/cloud.mov','static/sentence3/above.mov','static/sentence3/be.mov','static/sentence3/if.mov','static/sentence3/here.mov','static/sentence3/probably.mov'];
guideVideo_list['2']= ['static/sentence3/cloud.mov','static/sentence3/above.mov','static/sentence3/be.mov','static/sentence3/if.mov','static/sentence3/here.mov','static/sentence3/probably.mov'];
...
const detection= 'sentence'.concat(s_num);
alert(detection);
var goal_idx=0;
