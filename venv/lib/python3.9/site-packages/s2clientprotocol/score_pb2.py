...
_SCOREDETAILS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='current_apm', full_name='SC2APIProtocol.ScoreDetails.current_apm', index=26,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='current_effective_apm', full_name='SC2APIProtocol.ScoreDetails.current_effective_apm', index=27,
